...
API_KEY = os.getenv("AIzaSyCFbnID7J4KnD-hoveRc37CEx_MV9eXUEk")
...
if st.button("Your Travel Plan"):
    if source and destination:
        with st.spinner("Compiling all travel options...."):
            ...
            chat_model = ChatGoogleGenerativeAI(api_key = "AIzaSyCFbnID7J4KnD-hoveRc37CEx_MV9eXUEk", model = "gemini-2.0-flash-exp")
